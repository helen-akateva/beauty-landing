          ...
          <ul class="list-online">
            <li class="item-online">
              <article class="content-card">
                ...
                <div class="card-body">
                  ...
                  <h4 class="title-card">Курс "Стрілки на Easy"</h4>
                  <p class="text-card">
            ...
            <li class="item-online">
              <article class="content-card">
                ...
                <div class="card-body">
                  <span class="badge badge-online">Online</span>
                  <h4 class="title-card">Курс "Nude makeup"</h4>
                  <p class="text-card">
          ...
          <ul class="list-offline">
            <li class="item-offline">
              <article class="content-card">
                <div class="card-body">
                  ...
                  <h4 class="title-card">Макіяж для себе</h4>
                  <p class="text-card">
            ...
            <li class="item-offline">
              <article class="content-card">
                <div class="card-body">
                  ...
                  <h4 class="title-card">Базовий макіяж Nude</h4>
                  <p class="text-card">
            ...
            <li class="item-offline">
              <article class="content-card">
                <div class="card-body">
                  <span class="badge badge-offline">Offline • 1 заняття</span>
                  <h4 class="title-card">Макіяж для виступу дитини</h4>
                  <p class="text-card">
